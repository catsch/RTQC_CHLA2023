...
RES=FLUORESCENCE_CHLA-MED_FLUO_CHLA ## Equation 4

Q10=rep(quantile(RES,0.10,na.rm=TRUE),length(FLUORESCENCE_CHLA))

############ Remove from the estimation of the dark outliers

FLUORESCENCE_CHLA[RES<Q10]=NA #### Remove outliers (not sure that is the best way )
